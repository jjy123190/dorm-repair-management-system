...
- 当前仓库已经补了 [../sql/mysql/02_seed_demo_data.sql](../sql/mysql/02_seed_demo_data.sql)
- 建库时推荐按 `01_init_schema_v1.sql -> 02_seed_demo_data.sql` 的顺序执行
- `02_seed_demo_data.sql` 会刷新一组保留的演示 ID，不会清空整库：
  - 用户：`1001-1003`、`2001-2002`、`3001-3003`
  - 房间：`9001-9006`
  - 报修单：`5001-5006`
  - 工单：`6001-6006` 中当前已用的演示单号
- 演示数据与 `DemoAccountDirectory` 保持一致，方便登录页稳定账号、首页概览、学生记录、管理员派单、维修处理和月度统计一起联调
