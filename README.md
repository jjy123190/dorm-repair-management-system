...
- 学生提交报修、上传图片、查看历史记录、催办、取消、确认完成、申请返修、提交评价
- 管理员派单、内部用户管理、宿舍目录维护、审计日志、月度统计查看
- 维修员待处理工单筛选、接单、处理中、完工状态更新与完工凭证上传
...
- 继续完善课程交付材料，把课程报告、ER 图、运行截图和答辩 PPT 收齐
- 继续完善 demo seed，让 fresh DB 启动后三种角色页面都能直接看到更丰富的演示数据
